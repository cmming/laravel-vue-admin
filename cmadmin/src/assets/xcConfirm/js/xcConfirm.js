...
(function ($) {
    ...
    window.wxc.xcConfirm = function (popHtml, type, options) {
        ...
        var $ttBox = $("<div>").addClass("ttBox canDrag");//弹窗顶部区域
        ...
        function bind() {
            ...
            //         console.log(1);
            //         var isMove = true;
            //         var abs_x = event.pageX - $popBox.offset().left;
            //         var abs_y = event.pageY - $popBox.offset().top;
            //         $(document).mousemove(function (event) {
            //                 if (isMove) {
            //                     var obj = $popBox;
            //                     obj.css({'left': event.pageX + abs_x/2, 'top': event.pageY + abs_y/2});
            //                 }
            //             }
            //         ).mouseup(
            //             function () {
